...
/**
 * 类功能描述： MjtjResourceModel.java
 * 
 * @author vteamdell0723
 * @version 0.1.0
 * @history 2014-4-24 vteamdell0723 创建MjtjResourceModel.java
 */
public class MjtjResourceModel implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8330167829121777956L;
