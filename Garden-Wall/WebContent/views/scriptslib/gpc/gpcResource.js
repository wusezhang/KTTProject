                ...
                var cols = [
                    ...
                    { title:'股票价格',align: 'center', cols:[
                        ...
                        { title:'涨跌幅', name:'DAYCHANGERATE' ,width:60, align:'right', sortable: true, type: 'number',renderer: function(val){
                            if(val > 0){
                                return '<input style="color: #b00;width: 45px"  value='+val.toFixed(2)+'>' + '</input>';
                            }else if(val < 0){
                                return '<input style="color: #0b0;width: 45px"  value='+val.toFixed(2)+'>' + '</input>';
                            }
                            return val.toFixed(2)+'%';
                        }},
